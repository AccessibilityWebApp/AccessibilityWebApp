        ...
        <div id="login-form">
            ...
            <Form noValidate validated={validated} onSubmit={handleSubmit}>
                <Form.Group controlId="username">
                    ...
                    <Form.Control.Feedback type="invalid">Vul uw gebruikersnaam in.</Form.Control.Feedback>
                </Form.Group>

                <Form.Group controlId="password">
                    <Form.Label>Wachtwoord:</Form.Label>
                    <Form.Control type="password" name="password" required />
                    <Form.Control.Feedback type="invalid">Vul uw wachtwoord in.</Form.Control.Feedback>
                </Form.Group>
                ...
                <Button variant="link" type="submit" size="sm" className="mt-2 p-0">
                    Wachtwoord vergeten?
                </Button>

                <p className="forgotPass">Heb je nog geen account?</p>

                <Button href="expert_signup" variant="success" type="submit" size="sm" className="mt-2 text-left">
                    Registreren
                </Button>
            </Form>
        </div>
